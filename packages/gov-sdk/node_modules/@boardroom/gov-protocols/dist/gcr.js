...
exports.registerGlobalCoinResearch = void 0;
const gov_adapters_1 = require("@boardroom/gov-adapters");
const registerGlobalCoinResearch = (register, transports, snapshotApiKey, boardroomAPIKey) => {
    const cname = 'gcr';
    register({
        cname: cname,
        ...
        adapters: (adapters) => {
            ...
            const coingecko = new gov_adapters_1.CoinGeckoAdapter('global-coin-research', transports);
...
exports.registerGlobalCoinResearch = registerGlobalCoinResearch;
