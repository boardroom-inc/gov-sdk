...
exports.registerUniswap = void 0;
const gov_adapters_1 = require("@boardroom/gov-adapters");
class UniswapProposalAdapter extends gov_adapters_1.CompoundGovernorAlphaAdapter {
...
class UniswapProposalBravoAdapter extends gov_adapters_1.CompoundGovernorBravoAdapter {
    async getExternalLink() {
        return {
            name: 'Uniswap Governance',
            url: 'https://app.uniswap.org/#/vote',
    ...
    async getProposals(pagination = {}) {
        const governor = new gov_adapters_1.CompoundGovernorBravoContract(await this.getGovernanceAddress(), await this.getTransports());
        ...
        const proposals = results.items
            ...
            .map((item) => gov_adapters_1.mapProposal(item.parsed, ['AGAINST', 'FOR', 'ABSTAIN'], quorum, item.event.transactionHash));
        return { items: proposals, nextCursor: results.nextCursor };
    }
}
const registerUniswap = (register, transports, snapshotApiKey, boardroomAPIKey, etherscanMainnetAPIKey) => {
    const cname = 'uniswap';
    register({
        cname: cname,
        name: 'Uniswap',
        ...
        adapters: (adapters) => {
            ...
            const coingecko = new gov_adapters_1.CoinGeckoAdapter('uniswap', transports);
            // Treasury addresses sourced from https://github.com/dmihal/open-orgs.info/tree/master/data/adapters
            const treasury = new gov_adapters_1.CovalentAdapter(['0x1a9c8182c09f50c8318d769245bea52c32be35bc', '0x4750c43867ef5f89869132eccf19b9b6c4286e1a'], 1, transports);
...
exports.registerUniswap = registerUniswap;
