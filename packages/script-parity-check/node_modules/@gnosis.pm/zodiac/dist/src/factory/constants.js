...
const erc20_votes_1 = __importDefault(require("../abi/erc20_votes"));
const erc721_votes_1 = __importDefault(require("../abi/erc721_votes"));
const oz_governor_1 = __importDefault(require("../abi/oz_governor"));
const types_1 = require("./types");
var SUPPORTED_NETWORKS;
(function (SUPPORTED_NETWORKS) {
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["Mainnet"] = 1] = "Mainnet";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["Goerli"] = 5] = "Goerli";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["BinanceSmartChain"] = 56] = "BinanceSmartChain";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["GnosisChain"] = 100] = "GnosisChain";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["Polygon"] = 137] = "Polygon";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["Mumbai"] = 80001] = "Mumbai";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["ArbitrumOne"] = 42161] = "ArbitrumOne";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["Optimism"] = 10] = "Optimism";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["Avalanche"] = 43114] = "Avalanche";
    SUPPORTED_NETWORKS[SUPPORTED_NETWORKS["HardhatNetwork"] = 31337] = "HardhatNetwork";
...
const MasterCopyAddresses = {
    ...
    [types_1.KnownContracts.FACTORY]: "0x00000000000DC7F163742Eb4aBEf650037b1f588",
...
exports.CONTRACT_ADDRESSES = {
    [SUPPORTED_NETWORKS.Mainnet]: {
        ...
        [types_1.KnownContracts.OPTIMISTIC_GOVERNOR]: "0x56C11dE61e249cbBf337027B53Ed3b1dFA8a4e6F",
    },
    [SUPPORTED_NETWORKS.Goerli]: {
        ...MasterCopyAddresses,
        [types_1.KnownContracts.OPTIMISTIC_GOVERNOR]: "0x1340229DCF6e0bed7D9c2356929987C2A720F836",
        [types_1.KnownContracts.OZ_GOVERNOR]: "0x011Ad6A7FE4FB9226204dDBe2b6a5Fc109961dce",
        [types_1.KnownContracts.ERC20_VOTES]: "0x245CA18e8c05500160D2F0B406f89167C9efDF86",
        [types_1.KnownContracts.ERC721_VOTES]: "0x26fBbE4b69d737a8EF7afa71056256900d6647c9",
    },
    ...
    [SUPPORTED_NETWORKS.Polygon]: {
        ...
        [types_1.KnownContracts.OPTIMISTIC_GOVERNOR]: "0x923b1AfF7D67507A5Bdf528bD3086456FEba10cB",
    },
    ...
    [SUPPORTED_NETWORKS.ArbitrumOne]: { ...MasterCopyAddresses },
    [SUPPORTED_NETWORKS.Optimism]: { ...MasterCopyAddresses },
...
exports.CONTRACT_ABIS = {
    ...
    ozGovernor: oz_governor_1.default,
    erc20Votes: erc20_votes_1.default,
    erc721Votes: erc721_votes_1.default,
};
