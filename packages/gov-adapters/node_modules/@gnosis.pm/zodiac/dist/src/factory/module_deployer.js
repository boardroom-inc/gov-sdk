...
const deployAndSetUpCustomModule = (mastercopyAddress, abi, setupArgs, provider, chainId, saltNonce) => {
    ...
    const moduleFactory = new ethers_1.Contract(moduleFactoryAddress, constants_1.CONTRACT_ABIS.factory, provider);
...
const getModuleInstance = (moduleName, moduleAddress, provider) => {
    ...
    return new ethers_1.Contract(moduleAddress, constants_1.CONTRACT_ABIS[moduleName], provider);
};
...
const getModuleFactoryAndMasterCopy = (moduleName, provider, chainId) => {
    ...
    const moduleFactory = new ethers_1.Contract(factoryAddress, constants_1.CONTRACT_ABIS.factory, provider);
    return {
        moduleFactory,
        moduleMastercopy,
    };
