...
var _ModuleManager_ethers, _ModuleManager_safeContract;
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils");
const constants_1 = require("../utils/constants");
class ModuleManager {
    constructor(ethers, safeContract) {
        _ModuleManager_ethers.set(this, void 0);
        _ModuleManager_safeContract.set(this, void 0);
        __classPrivateFieldSet(this, _ModuleManager_ethers, ethers, "f");
        __classPrivateFieldSet(this, _ModuleManager_safeContract, safeContract, "f");
    }
    validateModuleAddress(moduleAddress) {
        const isValidAddress = __classPrivateFieldGet(this, _ModuleManager_ethers, "f").utils.isAddress(moduleAddress);
        if (!isValidAddress || utils_1.isRestrictedAddress(moduleAddress)) {
            throw new Error('Invalid module address provided');
        }
    }
    validateModuleIsNotEnabled(moduleAddress, modules) {
        const moduleIndex = modules.findIndex((module) => utils_1.sameString(module, moduleAddress));
    ...
    async encodeEnableModuleData(moduleAddress) {
        ...
        return __classPrivateFieldGet(this, _ModuleManager_safeContract, "f").interface.encodeFunctionData('enableModule', [moduleAddress]);
    }
    async encodeDisableModuleData(moduleAddress) {
        ...
        return __classPrivateFieldGet(this, _ModuleManager_safeContract, "f").interface.encodeFunctionData('disableModule', [
            prevModuleAddress,
            moduleAddress
        ]);
    }
}
_ModuleManager_ethers = new WeakMap(), _ModuleManager_safeContract = new WeakMap();
