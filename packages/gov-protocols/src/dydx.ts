...
class DydxAdapter extends AaveGovernanceV2Adapter {
...
export const registerDydx: ProtocolRegistrationFunction = (register, transports, snapshotApiKey, boardroomAPIKey) => {
  const cname = 'dydx';
  register({
    cname: cname,
    name: 'dYdX',
    ...
    adapters: (adapters) => {
      const coingecko = new CoinGeckoAdapter('dydx', transports);
      ...
      const treasury = new CovalentAdapter(
        ['0xE710CEd57456D3A16152c32835B5FB4E72D9eA5b', '0x08a90Fe0741B7DeF03fB290cc7B273F1855767D8'],
        1,
        transports
      );
