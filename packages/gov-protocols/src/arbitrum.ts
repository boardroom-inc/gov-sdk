...
export const registerArbitrum: ProtocolRegistrationFunction = (
  register,
  transports,
  snapshotApiKey,
  boardroomAPIKey,
  ...
  register({
    ...
    adapters: (adapters) => {
      ...
      const governorCore = new OpenZeppelinGovernorAdapter({
      ...
      const governorTreasury = new OpenZeppelinGovernorAdapter({
      ...
      const coingecko = new CoinGeckoAdapter('arbitrum', transports);
            ...
            icons: [
              {
                size: 'normal',
                url:
                  'https://ik.imagekit.io/4fqrcsooovf/Projects/51cc280c-b992-4f5c-8190-d5aabd1f82c9_original_c_Czlz8oO.webp',
              },
            ],
          };
        },
