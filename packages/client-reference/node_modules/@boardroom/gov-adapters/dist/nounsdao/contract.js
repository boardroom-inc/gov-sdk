...
exports.NounsGovernorContract = void 0;
...
class NounsGovernorContract {
    ...
    async getDelegationEvents(chainId, cursor, startBlock, endBlock) {
        const rpc = this.transports('rpc').network(chainId);
        const contract = new ethers_1.Contract(this.address, abi_nouns_json_1.default, rpc);
        const response = await (0, rpc_1.queryEventLogs)({
            rpc,
            cursor,
            contract,
...
exports.NounsGovernorContract = NounsGovernorContract;
