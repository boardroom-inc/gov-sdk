...
exports.registerHarvestFinance = void 0;
const gov_adapters_1 = require("@boardroom/gov-adapters");
const registerHarvestFinance = (register, transports, snapshotApiKey, boardroomAPIKey) => {
    ...
    register({
        ...
        adapters: (adapters) => {
            ...
            const coingecko = new gov_adapters_1.CoinGeckoAdapter('harvest-finance', transports);
...
exports.registerHarvestFinance = registerHarvestFinance;
//# sourceMappingURL=harvestfinance.js.map