...
exports.registerJam = void 0;
const gov_adapters_1 = require("@boardroom/gov-adapters");
const registerJam = (register, transports, boardroomAPIKey) => {
    const cname = 'jam';
    register({
        cname: cname,
        name: 'Jam',
        ...
        adapters: (adapters) => {
            ...
            const treasury = new gov_adapters_1.CovalentAdapter('0x594af91dfbcc256050f4aa0251838bc89fa354e5', 1, transports);
...
exports.registerJam = registerJam;
