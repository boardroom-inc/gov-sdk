...
var _OwnerManager_ethers, _OwnerManager_safeContract;
Object.defineProperty(exports, "__esModule", { value: true });
const utils_1 = require("../utils");
const constants_1 = require("../utils/constants");
class OwnerManager {
    constructor(ethers, safeContract) {
        _OwnerManager_ethers.set(this, void 0);
        _OwnerManager_safeContract.set(this, void 0);
        __classPrivateFieldSet(this, _OwnerManager_ethers, ethers, "f");
        __classPrivateFieldSet(this, _OwnerManager_safeContract, safeContract, "f");
    }
    validateOwnerAddress(ownerAddress, errorMessage) {
        const isValidAddress = __classPrivateFieldGet(this, _OwnerManager_ethers, "f").utils.isAddress(ownerAddress);
        if (!isValidAddress || utils_1.isRestrictedAddress(ownerAddress)) {
    ...
    validateAddressIsNotOwner(ownerAddress, owners, errorMessage) {
        const ownerIndex = owners.findIndex((owner) => utils_1.sameString(owner, ownerAddress));
    ...
    async getThreshold() {
        return (await __classPrivateFieldGet(this, _OwnerManager_safeContract, "f").getThreshold()).toNumber();
    }
    ...
    async encodeAddOwnerWithThresholdData(ownerAddress, threshold) {
        ...
        return __classPrivateFieldGet(this, _OwnerManager_safeContract, "f").interface.encodeFunctionData('addOwnerWithThreshold', [
            ownerAddress,
            newThreshold
        ]);
    }
    async encodeRemoveOwnerData(ownerAddress, threshold) {
        ...
        return __classPrivateFieldGet(this, _OwnerManager_safeContract, "f").interface.encodeFunctionData('removeOwner', [
            prevOwnerAddress,
            ownerAddress,
            newThreshold
        ]);
    ...
    async encodeSwapOwnerData(oldOwnerAddress, newOwnerAddress) {
        ...
        return __classPrivateFieldGet(this, _OwnerManager_safeContract, "f").interface.encodeFunctionData('swapOwner', [
            prevOwnerAddress,
            oldOwnerAddress,
            newOwnerAddress
        ]);
    ...
    async encodeChangeThresholdData(threshold) {
        ...
        return __classPrivateFieldGet(this, _OwnerManager_safeContract, "f").interface.encodeFunctionData('changeThreshold', [threshold]);
    }
}
_OwnerManager_ethers = new WeakMap(), _OwnerManager_safeContract = new WeakMap();
